...
tasks.register("syncWithGradleFiles") {
    dependsOn(
        ...
        ":composeApp:podSetupBuildFirebaseStorageIphoneos",
        ":composeApp:podBuildFirebaseStorageIphoneos",
        ":composeApp:cinteropFirebaseStorageIosArm64",
        ":composeApp:podSetupBuildFirebaseStorageIphonesimulator",
        ":composeApp:podBuildFirebaseStorageIphonesimulator",
        ":composeApp:cinteropFirebaseStorageIosSimulatorArm64",
        ":composeApp:cinteropFirebaseStorageIosX64",
